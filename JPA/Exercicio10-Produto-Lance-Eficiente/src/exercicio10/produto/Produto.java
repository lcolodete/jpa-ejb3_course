...
{	private Long id;
	...
	/* 
	 * Ver comentários sobre o @OrderBy no exercicio 9.
	 * 
	 * Sem as opções CascadeType.PERSIST e  CascadeType.MERGE  em
	 * função da forma como o Lance é persistido, isto é, sem ser
	 * acrescentado à coleção de lances de um produto.
	 * 
