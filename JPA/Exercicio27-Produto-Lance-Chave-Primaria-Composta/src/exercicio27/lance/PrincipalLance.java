...
/* ==> */	System.out.println("3. Recuperar um lance e seu respectivo produto");
			...
			{	case 1:
				...
				{	int idProduto = Console.readInt('\n' + 
					...
					System.out.println('\n' + 
						"Número do produto = " + umLance.getId().getIdProduto() + 
						"    Número do lance = " + umLance.getId().getNumeroLance() + 
				...
				{	List<Lance> arrayLances = lanceAppService.recuperaListaDeLances();
					...
					{	System.out.println(	
							"Número do produto = " + lance.getId().getIdProduto() + 
							"  Número do lance = " + lance.getId().getNumeroLance() + 
